export const grammaticalterms = [
  {
    "category": "Grammatical Terms",
    "question": "What does the Aramaic term מִלַּת חִבּוּר (millat ḥibbur) mean?",
    "options": [
      "Preposition",
      "Conjunction",
      "Adverb",
  ...
  {
    "category": "Grammatical Terms",
    "question": "What does the suffix ־ָן (-an) do in Aramaic?",
    "options": [
      "Forms plural nouns",
      "Forms adjectives describing characteristics from nouns",
  ...
  {
    "category": "Grammatical Terms",
    "question": "What does the suffix ־וּ (-u) indicate in Aramaic verbs?",
    "options": [
  ...
  {
    "category": "Grammatical Terms",
    "question": "What does the suffix ־וּת (-ut) do in Aramaic?",
    "options": [
      "Forms plural nouns",
      "Creates diminutives",
      "Forms abstract nouns from concrete words",
  ...
  {
    "category": "Grammatical Terms",
    "question": "What does the prefix מְ־ (me-) do in Aramaic?",
    "options": [
      "Forms causative verbs",
      "Forms participles and agent nouns from verbs",
      "Creates negation",
  ...
  {
    "category": "Grammatical Terms",
    "question": "What does the prefix אַ־ (a-) do in Aramaic?",
    "options": [
      "Forms reflexive verbs",
      "Forms participles",
      "Forms causative verbs in the Af'el binyan",
