export const numbers = [
  ...
  {
    "category": "Numbers",
    "question": "How is the number '11' expressed in Aramaic?",
    "options": [
      "עֲשַׂר וְחַד (asar ve-ḥad)",
      "חַד עֲשַׂר/חַד עַסְרָא (ḥad asar/ḥad asra)",
  ...
  {
    "category": "Numbers",
    "question": "How does Aramaic typically express possession?",
    "options": [
      "Using a genitive case ending",
      "Using a verb meaning 'to have'",
      "Using a prepositional phrase with לְ (l'-)",
      "Using only the construct state"
    ],
    "correct": 2,
  ...
  {
    "category": "Numbers",
    "question": "How is negation typically expressed in Aramaic?",
    "options": [
  ...
  {
    "category": "Numbers",
"question": "How are questions typically formed in Aramaic?",
    "options": [
      "By changing the word order",
      "By adding the prefix הַ- (ha-)",
      "By using interrogative particles like מַאן (man) or מַאי (mai)",
