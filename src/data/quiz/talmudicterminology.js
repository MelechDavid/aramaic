export const talmudicterminology = [
  {
    "category": "Talmudic Terminology",
    "question": "What does the suffix ־וּת (-ut) do when added to Aramaic words?",
    "options": [
      "Creates plural forms",
      "Forms abstract nouns expressing concepts or states",
  ...
  {
    "category": "Talmudic Terminology",
    "question": "What does the prefix מְ־ (me-) do when added to Aramaic verb roots?",
    "options": [
      "Creates past tense forms",
      "Forms verbal participles functioning as present tense or agent nouns",
      "Marks negation",
  ...
  {
    "category": "Talmudic Terminology",
    "question": "What does the prefix אַ־ (a-) do in the Aramaic Af'el binyan?",
    "options": [
      "Creates reflexive verbs",
      "Forms causative verbs indicating that a subject causes an action",
      "Marks passive voice",
  ...
  {
    "category": "Talmudic Terminology",
    "question": "What does the prefix אִת־ (it-) do in Aramaic?",
    "options": [
      "Forms causative verbs",
      "Forms reflexive/passive verbs where the subject receives or performs the action on itself",
