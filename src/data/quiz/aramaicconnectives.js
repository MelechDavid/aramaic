export const aramaicconnectives = [
  {
    "category": "Aramaic Connectives",
    "question": "What does the Aramaic connective בְּרַם (beram) express?",
    "options": [
      "Purpose ('in order to')",
      "Contrast or exception ('but/however')",
      "Cause ('because')",
      "Time ('when')"
    ],
    "correct": 1,
...
"question": "What does the term הלכתא (hilkhata) refer to in the Talmud?",
  ...
  {
    "category": "Aramaic Connectives",
    "question": "What does the suffix ־ָן (-an) do when added to Aramaic nouns?",
    "options": [
      "Creates plural nouns",
      "Forms abstract nouns",
      "Forms adjectives describing characteristics",
      "Marks past tense verbs"
    ],
    "correct": 2,
  ...
  {
    "category": "Aramaic Connectives",
    "question": "What does the suffix ־וּ (-u) indicate in Aramaic perfect (past tense) verbs?",
    "options": [
