export const loanwords = [
  {
    "category": "Loan Words",
    "question": "What does the Aramaic term סְבָרָא (sevara) refer to in Talmudic reasoning?",
    "options": [
      "A textual proof from Scripture",
      "Logical reasoning applied to interpret the law",
      "A tradition received from earlier sages",
  ...
  {
    "category": "Loan Words",
    "question": "What does the term מתניתין (matnitin) refer to in the Babylonian Talmud?",
    "options": [
      "A rabbinical interpretation",
      "The Mishnah passage being discussed",
  ...
  {
    "category": "Loan Words",
    "question": "What does the term גמרא (gemara) refer to?",
    "options": [
      "The collection of Tannaitic teachings",
      "The Mishnah text itself",
      "The commentary and analysis of the Mishnah",
      "The mystical interpretations of Torah"
    ],
    "correct": 2,
