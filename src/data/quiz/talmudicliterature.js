export const talmudicliterature = [
  {
    ...
    "options": [
      ...
      "Mystical interpretations of Torah",
  ...
  {
    "category": "Talmudic Literature",
    "question": "What is the Aramaic grammatical term for 'verb'?",
    "options": [
      "שֵׁם (shem)",
      "פּוֹעַל (po'al)",
      "תּוֹאַר (to'ar)",
  ...
  {
    "category": "Talmudic Literature",
    "question": "What is the Aramaic grammatical term for 'noun'?",
    "options": [
      "פּוֹעַל (po'al)",
      "שֵׁם (shem)",
      "כִּנּוּי (kinnui)",
  ...
  {
    "category": "Talmudic Literature",
    "question": "What is the Aramaic grammatical term for 'adjective'?",
    "options": [
      "שֵׁם (shem)",
      "פּוֹעַל (po'al)",
      "תּוֹאַר (to'ar)",
  ...
  {
    "category": "Talmudic Literature",
    "question": "What is the Aramaic grammatical term for 'preposition'?",
    "options": [
  ...
  {
    "category": "Talmudic Literature",
    "question": "What is the Aramaic grammatical term for 'pronoun'?",
    "options": [
      "שֵׁם (shem)",
      "תּוֹאַר (to'ar)",
      "כִּנּוּי (kinnui)",
  ...
  {
    "category": "Talmudic Literature",
    "question": "What is the Aramaic grammatical term for 'adverb'?",
    "options": [
      "מִלַּת חִבּוּר (millat ḥibbur)",
      "שֵׁם פֹּעַל (shem po'al)",
      "כִּנּוּי (kinnui)",
