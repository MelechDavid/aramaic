export const aramaicsuffixes = [
  {
    "category": "Aramaic Suffixes",
    "question": "What does the prefix בְּ־ (be-) indicate in Aramaic?",
    "options": [
      "Direction ('to', 'toward')",
      "Location, time, or means ('in', 'at', 'by')",
      "Possession ('of')",
      "Negation ('not')"
    ],
    "correct": 1,
  ...
  {
    "category": "Aramaic Suffixes",
    "question": "What is the function of the Aramaic conjunction וְ־ (ve-)?",
    "options": [
      "Expresses disjunction ('or')",
      "Serves as the primary conjunction ('and')",
  ...
  {
    "category": "Aramaic Suffixes",
    "question": "What does the Aramaic connective כְּדֵי (kedei) express?",
    "options": [
      "Cause ('because')",
      "Condition ('if')",
